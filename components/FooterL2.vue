	...
	<div>
		<div class="page-wrapper">
			...
			<footer class="main-footer">
				...
				<div class="pattern-layer-one" style="background-image: url(/webAssets/images/background/pattern-12.png)"></div>
				<div class="pattern-layer-two" style="background-image: url(/webAssets/images/background/pattern-13.png)"></div>
				<div class="pattern-layer-three" style="background-image: url(/webAssets/images/background/pattern-14.png)"></div>
				<div class="pattern-layer-four" style="background-image: url(/webAssets/images/background/pattern-13.png)"></div>
						...
						<div class="row clearfix">
							...
							<div class="footer-column col-lg-5 col-md-12 col-sm-12">
								<div class="footer-widget logo-widget">
									<div class="logo">
										<a href="index-2.html"><img src="/webAssets/images/logo.png" alt="" /></a>
									</div>
									<ul class="info-list">
										<li>Tel:<a href="tel:+0845-371-02-02"> 0845 371 02 02</a></li>
										<li>Email:<a href="http://themazine.com/cdn-cgi/l/email-protection#d9b0b7bfb699a0b6acabaab0adbcf7bab6f7acb2"> <span class="__cf_email__" data-cfemail="fb92959d94bb82948e8988928f9ed59894d58e90">[email&#160;protected]</span></a></li>
									</ul>
									<!-- Social Box -->
									<ul class="social-box">
