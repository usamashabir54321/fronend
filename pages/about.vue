<template>
	<div class="page-wrapper">
					...
					<div class="sidebar-textwidget">
						...
						<div class="sidebar-info-contents">
							<div class="content-inner">
								<div class="logo">
									<a href="index-2.html"><img src="/webAssets/images/logo-2.png" alt="" /></a>
								</div>
								...
								<div class="contact-info">
									...
									<ul class="list-style-two">
										...
										<li><span class="icon fa fa-envelope"></span><a href="http://themazine.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="b3dfd6d1d2c1daf3d4ded2dadf9dd0dcde">[email&#160;protected]</a></li>
	    ...
	    <section class="banner-section-three">
			<div class="pattern-layer-two" style="background-image: url(/webAssets/images/background/pattern-21.png)"></div>
	            ...
	            <div class="row clearfix">
					...
					<div class="content-column col-lg-8 col-md-12 col-sm-12">
						<div class="inner-column">
							...
							<div class="icon-layer" style="background-image: url(/webAssets/images/icons/icon-2.png)"></div>
							<div class="icon-layer-two" style="background-image: url(/webAssets/images/icons/icon-5.png)"></div>
					...
					<div class="image-column col-lg-4 col-md-12 col-sm-12">
						<div class="inner-column">
							<div class="icon-layer-three" style="background-image: url(/webAssets/images/icons/icon-3.png)"></div>
							<div class="icon-layer-four" style="background-image: url(/webAssets/images/icons/icon-2.png)"></div>
							<div class="icon-layer-five" style="background-image: url(/webAssets/images/icons/icon-4.png)"></div>
							<div class="image">
								<img src="/webAssets/images/resource/page-title-1.jpg" alt="" />
							</div>
							<div class="image-two">
								<img src="/webAssets/images/resource/page-title-2.jpg" alt="" />
							</div>
						</div>
					</div>
		...
		<section class="goal-section style-two">
			<div class="pattern-layer-four" style="background-image:url(/webAssets/images/background/pattern-18.png)"></div>
			<div class="auto-container">
				<div class="row clearfix">
					...
					<div class="images-column col-lg-6 col-md-12 col-sm-12">
						...
						<div class="inner-column">
							<div class="pattern-layer" style="background-image:url(/webAssets/images/background/pattern-4.png)"></div>
							<div class="pattern-layer-two" style="background-image:url(/webAssets/images/background/pattern-17.png)"></div>
							<div class="image">
								<img src="/webAssets/images/resource/goal-1.jpg" alt="" />
							</div>
							<div class="image-two">
								<img src="/webAssets/images/resource/goal-2.jpg" alt="" />
							</div>
						</div>
					</div>
					...
					<div class="content-column col-lg-6 col-md-12 col-sm-12">
						<div class="inner-column">
							<div class="pattern-layer-three" style="background-image:url(/webAssets/images/background/pattern-13.png)"></div>
							<div class="sec-title">
		...
		<section class="skill-section">
			<div class="pattern-layer" style="background-image:url(/webAssets/images/background/pattern-8.png)"></div>
			<div class="auto-container">
				<div class="row clearfix">
					...
					<div class="image-column col-lg-5 col-md-12 col-sm-12">
						<div class="inner-column">
							...
							<div class="image titlt" data-tilt data-tilt-max="4">
								<img src="/webAssets/images/resource/skill.png" alt="" />
							</div>
						</div>
					</div>
		...
		<section class="professional-section style-two">
			...
			<div class="auto-container">
				<div class="row clearfix">
					...
					<div class="images-column col-lg-6 col-md-12 col-sm-12">
						<div class="inner-column">
							...
							<div class="image wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
								<img src="/webAssets/images/resource/professional.jpg" alt="" />
							</div>
						</div>
					</div>
					...
					<div class="content-column col-lg-6 col-md-12 col-sm-12">
						<div class="inner-column">
							<div class="pattern-layer-three" style="background-image:url(/webAssets/images/background/pattern-16.png)"></div>
							<div class="sec-title">
						...
						<div class="testimonial-block-two">
							<div class="inner-box">
								...
								<div class="author-info">
									<div class="info-inner">
										<div class="author-image">
											<img src="/webAssets/images/resource/author-2.jpg" alt="" />
										</div>
						...
						<div class="testimonial-block-two">
							<div class="inner-box">
								...
								<div class="author-info">
									<div class="info-inner">
										<div class="author-image">
											<img src="/webAssets/images/resource/author-3.jpg" alt="" />
										</div>
										<h6>Alamin Sa</h6>
										<div class="designation">Online Teacher</div>
									</div>
		...
		<section class="team-section">
			<div class="auto-container">
				<div class="inner-container">
					<div class="color-layer"></div>
					<div class="pattern-layer" style="background-image:url(/webAssets/images/background/pattern-18.png)"></div>
					<div class="row clearfix">
							...
							<div class="inner-column">
								<div class="row clearfix">
									...
									<div class="team-block col-lg-6 col-md-6 col-sm-12">
										<div class="inner-box">
											<div class="image">
												<a href="course-detail.html"><img src="/webAssets/images/resource/team-1.jpg" alt="" /></a>
											</div>
									...
									<div class="team-block col-lg-6 col-md-6 col-sm-12">
										<div class="inner-box">
											<div class="image">
												<a href="course-detail.html"><img src="/webAssets/images/resource/team-2.jpg" alt="" /></a>
											</div>
											<div class="lower-content">
